...
import { getEntities,updateEntity, createEntity  } from './noidungdanhgia.reducer';
...
export type INoidungdanhgiaState = INoidungdanhgia;
    ...
    return (
      ...
      <div className="card card-quanlydulieu">
        <div className="card-header card-header-quanlydulieu">
          <div className="row">
            <div className="col-10"> <h5 className="title-quanlydulieu">DỮ LIỆU NỘI DUNG ĐÁNH GIÁ </h5></div>
          ...
          <div className="table-quanlydulieu">
            {noidungdanhgiaList && noidungdanhgiaList.length > 0 ? (
              <table className="table table-hover table-striped table-bordered" >
                ...
                <tbody>
                  {noidungdanhgiaList.map((noidung, i) => (
                    count++,
                    <tr key={`entity-${i}`}>
                      <td>{count}</td>
      ...
      <Modal isOpen={this.state.ModalAdd} className="modal-quanlydulieu">
        ...
        <div className="card card-modal-quanlydulieu">
          <div className="card-header card-header-modal-quanlydulieu">
            <span>MODAL NỘI DUNG ĐÁNH GIÁ</span>
          ...
          <div className="card-body card-body-modal-quanlydulieu">
              <div className="row">
                  <div className="col-12">
                        <label>Tên nội dung đánh giá</label>
