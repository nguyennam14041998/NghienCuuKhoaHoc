    ...
    return (
      <div>
        <h2 id="nguonkinhphi-heading">
          <Translate contentKey="nghienCuuKhoaHocApp.nguonkinhphi.home.title">Nguonkinhphis</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="nghienCuuKhoaHocApp.nguonkinhphi.home.createLabel">Create a new Nguonkinhphi</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {nguonkinhphiList && nguonkinhphiList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('noidung')}>
                    <Translate contentKey="nghienCuuKhoaHocApp.nguonkinhphi.noidung">Noidung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('sotiencap')}>
                    <Translate contentKey="nghienCuuKhoaHocApp.nguonkinhphi.sotiencap">Sotiencap</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('sudung')}>
                    <Translate contentKey="nghienCuuKhoaHocApp.nguonkinhphi.sudung">Sudung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="nghienCuuKhoaHocApp.nguonkinhphi.detai">Detai</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {nguonkinhphiList.map((nguonkinhphi, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{nguonkinhphi.detaiId ? <Link to={`detai/${nguonkinhphi.detaiId}`}>{nguonkinhphi.detaiId}</Link> : ''}</td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="nghienCuuKhoaHocApp.nguonkinhphi.home.notFound">No Nguonkinhphis found</Translate>
            </div>
          )}
        </div>
