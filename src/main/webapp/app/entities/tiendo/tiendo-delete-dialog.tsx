...
import { getEntity, deleteEntity } from './tiendo.reducer';
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="nghienCuuKhoaHocApp.tiendo.delete.question">
          <Translate contentKey="nghienCuuKhoaHocApp.tiendo.delete.question" interpolate={{ id: tiendoEntity.id }}>
