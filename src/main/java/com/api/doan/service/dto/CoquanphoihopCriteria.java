...
/**
 * Criteria class for the {@link com.api.doan.domain.Coquanphoihop} entity. This class is used
 * in {@link com.api.doan.web.rest.CoquanphoihopResource} to receive all the possible filtering options from
