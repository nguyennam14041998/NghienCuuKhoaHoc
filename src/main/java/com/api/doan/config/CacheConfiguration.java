...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.api.doan.domain.Nhansu.class.getName() + ".nhansuthamgias");
            createCache(cm, com.api.doan.domain.Nhansuthamgia.class.getName());
            createCache(cm, com.api.doan.domain.Chunhiem.class.getName());
            createCache(cm, com.api.doan.domain.Chunhiem.class.getName() + ".detais");
            createCache(cm, com.api.doan.domain.Coquanphoihop.class.getName());
            createCache(cm, com.api.doan.domain.Coquanphoihop.class.getName() + ".coquanphoihopthamgias");
            createCache(cm, com.api.doan.domain.Coquanphoihopthamgia.class.getName());
            ...
            createCache(cm, com.api.doan.domain.Detai.class.getName() + ".upfiles");
            createCache(cm, com.api.doan.domain.Detai.class.getName() + ".nhansuthamgias");
            createCache(cm, com.api.doan.domain.Detai.class.getName() + ".nguonkinhphis");
            createCache(cm, com.api.doan.domain.Detai.class.getName() + ".coquanphoihopthamgias");
            ...
            createCache(cm, com.api.doan.domain.Tiendo.class.getName() + ".upfiles");
            ...
            createCache(cm, com.api.doan.domain.Noidungdanhgia.class.getName() + ".danhgiaCTS");
